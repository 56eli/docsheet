...
python -m unittest discover tests     # 113 tests, offline, ~3s
...
| Test suite | **113 tests; coverage 91% total, every pipeline module ≥ 88%** (build_catalogue_pages.py = 88%) | `.coveragerc` enforces `fail_under = 85` (raised 2026-08-07) |
