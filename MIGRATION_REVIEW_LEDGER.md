...
|---|---:|---|
| `item` | 303 | Candidate flat catalogue records. No ID or catalogue code has been assigned yet. |
...
| `duplicate` | 3 | Duplicates of other item rows (Path to Spiritual Advancement truncated variant; legacy 2012 Discussion rows 318/321 — same talks as promoted masters 312/313, owner ruling 2026-08-07); retained as provenance, excluded from master. |
