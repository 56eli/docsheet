...
|---|---:|---|
| `item` | 302 | Candidate flat catalogue records; IDs/codes are assigned only downstream in the curated master. |
...
| `duplicate` | 4 | Duplicates of other item rows (Path to Spiritual Advancement truncated variant; legacy 2012 Discussion rows 318/321 — same talks as promoted masters 312/313; legacy row 296 — same NC audio edition as master 329, owner rulings 2026-08-07); retained as provenance, excluded from master. |
