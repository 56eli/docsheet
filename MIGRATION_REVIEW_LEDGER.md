...
|---|---:|---|
| `item` | 305 | Candidate flat catalogue records. No ID or catalogue code has been assigned yet. |
...
| `duplicate` | 1 | Duplicate of another item row (Path to Spiritual Advancement truncated variant); retained as provenance, excluded from master. |
