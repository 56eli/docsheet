...
|---|---:|---|
| `item` | 302 | Candidate flat catalogue records. No ID or catalogue code has been assigned yet. |
...
> `migration_review_ledger.csv` as of 2026-08-03, not the bootstrap output.
