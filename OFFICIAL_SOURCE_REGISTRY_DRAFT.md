...
## Additional global-discovery candidates — awaiting approval

These publishers were discovered after the initial four-source approval. Each has a publisher-controlled page that lists or sells Hawkins work, so each is a candidate for a dedicated source column once approved.

| Source name | Official catalogue URL | Market / evidence | Recommendation |
|---|---|---|---|
| Ediciones El Grano de Mostaza | https://elgranodemostaza.com/autores/david-r-hawkins/ | Spain; the publisher’s own author catalogue lists Spanish-language Hawkins books. [Author catalogue](https://elgranodemostaza.com/autores/david-r-hawkins/) | **Candidate — approve as Spanish-language publisher.** |
| Pandora Treinamentos / Pandora Editora | https://loja.pandoratreinamentos.com.br/combo-fa-de-hawkins | Brazil; its own store describes Portuguese-language Hawkins editions and identifies itself as the publisher. [Publisher store](https://loja.pandoratreinamentos.com.br/combo-fa-de-hawkins) | **Candidate — approve as Portuguese-language publisher.** |
| Guy Trédaniel Éditeur | https://www.editions-tredaniel.com/david-hawkins-auteur-806.html | France; its publisher-controlled author page and product records list French Hawkins editions. [Author catalogue](https://www.editions-tredaniel.com/david-hawkins-auteur-806.html) | **Candidate — approve as French-language publisher.** |
| Sheema Medien Verlag | https://www.sheema.de/ | Germany; German retail bibliographic records identify Sheema as publisher of German Hawkins editions, but a publisher-controlled Hawkins catalogue page was not found in this pass. [Example bibliographic retail record](https://www.buecher.de/shop/bewusstsein/heilung-und-genesung/hawkins-david-r-/products_products/detail/prod_id/35997498/) | **Research further** before registry inclusion. |
| Gruppo Editoriale Macro | https://www.gruppomacro.com/ | Italy; Italian bibliographic retail records identify Gruppo Editoriale Macro as publisher of an Italian *Power vs. Force* edition, but a publisher-controlled Hawkins catalogue page was not found in this pass. [Example bibliographic retail record](https://www.lafeltrinelli.it/potere-dei-condizionamenti-scacco-matto-libro-david-r-hawkins/e/9788828505150) | **Research further** before registry inclusion. |
| Les Éditions Ariane | https://www.editionsariane.com/ | French-language Canadian market; bibliographic records identify this publisher for *Cartographie de la conscience*, but a publisher-controlled Hawkins catalogue page was not found in this pass. [Example bibliographic record](https://www.librairielefailler.fr/ebook/9782896266159-cartographie-de-la-conscience-david-r-hawkins/) | **Research further** before registry inclusion. |
| Yes Publishing | https://www.yes-publishing.de/ | Germany; 2025 German *Letting Go* listings identify Yes Publishing, but this pass did not establish a publisher-controlled Hawkins catalogue page. [Example bibliographic retail record](https://www.preigu.de/buecher/loslassen/134311006) | **Research further** before registry inclusion. |
