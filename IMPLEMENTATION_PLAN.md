...
| Curated draft | The committed draft has 314 rows, whereas a clean isolated rebuild from the present ledger produces 308. | Reconcile the six draft-only records and 36 shared-record metadata differences before accepting a regenerated draft. Do **not** overwrite the committed output merely to make it match. |
